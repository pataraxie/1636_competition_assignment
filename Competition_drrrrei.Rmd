...
Metrics::rmse(exp(testing$income), exp(predict.train(rf_caret, newdata = testing))) # RMSE = 1026,33 // THIS IS OUR RMSE IN THE TRAINING DATASET
...
### The final .csv files
#write.csv2(predictions_holdout, "predictions.csv")
